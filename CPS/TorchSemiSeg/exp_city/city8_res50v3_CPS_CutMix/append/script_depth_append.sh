...
export snapshot_dir="/home/extraspace/Runs/CPS/Semi/1-$ratio/append_depth/$learning_rate_$epochs"


python train_depth_append.py #-m torch.distributed.launch --nproc_per_node=$NGPUS  #https://pytorch.org/docs/stable/elastic/run.html
