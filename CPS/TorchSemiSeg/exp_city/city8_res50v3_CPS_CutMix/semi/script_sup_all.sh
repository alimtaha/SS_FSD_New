...
export WORLD_SIZE=1
export mode="All_Full-Supervision"
export debug="False"
...
export snapshot_dir='/mnt/Dataset/Logs/SSL/CPS/Full/'


python train_sup_all.py  #-m torch.distributed.launch --nproc_per_node=$NGPUS  #https://pytorch.org/docs/stable/elastic/run.html
