...
with Engine(custom_parser=parser) as engine:
    ...
    for epoch in range(engine.state.epoch, config.nepochs):
        ...
        for idx in pbar:
            ...
            contrast_loss_l = criterion_contrast(img_feat_stu_1, depth_feat_stu_2, depth=None)  * config.contrast_weight
            contrast_loss_r = criterion_contrast(img_feat_stu_2, depth_feat_stu_1, depth=None)  * config.contrast_weight
            ...
            if config.sup_contrast:
                ...
                contrast_loss_l +=  (criterion_contrast(img_feat_sup_2, depth_feat_sup_1, depth=None)  * config.sup_contrast_weight)
                contrast_loss_r += (criterion_contrast(img_feat_sup_1, depth_feat_sup_2, depth=None)  * config.sup_contrast_weight)
            else:
