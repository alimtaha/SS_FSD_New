...
export WORLD_SIZE=1
export mode="Embeddings-Concat-Semi-Supervision"
export debug="False"
...
python train_depth_embeddings_concat.py  #-m torch.distributed.launch --nproc_per_node=$NGPUS  #https://pytorch.org/docs/stable/elastic/run.html
