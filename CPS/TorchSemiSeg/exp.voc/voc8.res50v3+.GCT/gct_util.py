...
class FlawDetector(nn.Module):
    ...
    def __init__(self, in_channels, norm_layer=None):
        ...
        self.classifier = nn.Conv2d(
            self.ndf * 8, 1, kernel_size=4, stride=2, padding=1)
    ...
    def forward(self, task_inp, task_pred):
        ...
        # x is not activated here since it will be activated by the criterion
        # function
...
class IBNorm(nn.Module):
    ...
    def __init__(self, num_features, split=0.5, norm_layer=None):
        ...
        self.inorm = nn.InstanceNorm2d(
            num_features=num_features - self.num_BN, affine=False)
...
class FlawmapHandler(nn.Module):
    ...
    def forward(self, flawmap):
        ...
        # maximum number is lower than threshold, set the error to 0.
