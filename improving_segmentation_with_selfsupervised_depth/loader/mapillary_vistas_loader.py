# Based on
# https://github.com/meetshah1995/pytorch-semseg/blob/master/ptsemseg/loader/mapillary_vistas_loader.py
...
class MapillaryVistasLoader(SequenceSegmentationLoader):
    ...
    def encode_segmap(self, mask):
        ...
        for l in range(0, self.n_classes + 1):
            cmask = (
                r == self.class_colors[l][0]) & (
                g == self.class_colors[l][1]) & (
                b == self.class_colors[l][2])
            id_mask[cmask] = l
        # Replace Mapillary unlabelled with default ignore index of our
        # framework
