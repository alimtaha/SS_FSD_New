...
parser.add_argument('--sampled_file',              type=str,   help='path to the sampled filenames text file', required=True)
...
parser.add_argument('--sampled',                            help='if set, uses sampled train_extra dataset', action='store_true')
...
prof = torch.profiler.profile(
        ...
        on_trace_ready=torch.profiler.tensorboard_trace_handler(args.log_directory + '/' + 'hyperparameters' + '/' + args.model_name + '/summaries'),
        record_shapes=True,
        with_stack=True)
prof.start()
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if not args.multiprocessing_distributed or (args.multiprocessing_distributed and args.rank % ngpus_per_node == 0):
        writer = SummaryWriter(args.log_directory + '/' + 'hyperparameters' + '/' + args.model_name + '/summaries', flush_secs=30)
