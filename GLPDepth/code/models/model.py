...
class GLPDepth(nn.Module):
    def __init__(self, max_depth=10.0, is_train=False):
        ...
        self.encoder = mit_b4()
        if is_train:
            ckpt_path = '/vol/biomedic2/aa16914/shared/amir_ali/ss_fsd/GLPDepth/code/models/weights/mit_b4.pth'
        ...
        self.last_layer_depth = nn.Sequential(
            nn.Conv2d(
                channels_out, channels_out, kernel_size=3, stride=1, padding=1), nn.ReLU(
                inplace=False), nn.Conv2d(
                channels_out, 1, kernel_size=3, stride=1, padding=1))
