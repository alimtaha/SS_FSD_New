...
def get_dataset(dataset_name, **kwargs):
    ...
    dataset_lib = importlib.import_module(              #configurable import statement, points to module name within package directory
        '.' + dataset_name, package='dataset')
    dataset_abs = getattr(dataset_lib, dataset_name)    #from x import y, the above provides x, this returns y (the class is usually the same name as the module)
