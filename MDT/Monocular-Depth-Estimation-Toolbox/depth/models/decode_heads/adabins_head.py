...
class PatchTransformerEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # embeddings = nn.functional.pad(embeddings, (1,0))  # extra special
        # token at start ?
...
class AdabinsHead(DenseDepthHead):
    ...
    def __init__(self,
        ...
        self.decode_final_conv = nn.Conv2d(
            self.channels,
            self.channels,
            kernel_size=3,
            stride=1,
    ...
    def forward(self, inputs, img_metas):
        ...
        bin_widths = (self.max_depth - self.min_depth) * \
